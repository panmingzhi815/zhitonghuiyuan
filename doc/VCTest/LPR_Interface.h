...
LPR_API unsigned int __stdcall LPR_GetShutterValue(PDEVICEHANDLE pHandle , SHUTTER_PARAMS *pValue);
...
LPR_API unsigned int __stdcall LPR_SetShutterValue(PDEVICEHANDLE pHandle , SHUTTER_PARAMS Value);

/*******************************************************************
函数实体：unsigned int WINAPI LPR_SetWorkMode(PDEVICEHANDLE pHandle , WORKMODE mode)
函数名称：LPR_SetWorkMode
函数说明：获取设备快门值
参数说明:
pHandle相机句柄，由LPR _ConnectCamera获取
mode：快门值，具体给值见WORKMODE定义
返回值：
返回值是RESULT_OK表示成功，否则返回错误代码
**********************************************************************/

LPR_API unsigned int __stdcall LPR_SetWorkMode(PDEVICEHANDLE pHandle ,WORKMODE mode);

/*******************************************************************
函数实体：unsigned int WINAPI LPR_ControlParams(PDEVICEHANDLE pHandle , ,ParamsInfo *params,unsigned int nTimeout)
函数名称：LPR_ControlParams
函数说明：设置或读取参数
参数说明:
pHandle相机句柄，由LPR _ConnectCamera获取
params：参数结构体，具体见ParamsInfo定义
nTimeout:命令执行等待时间
返回值：
返回值是RESULT_OK表示成功，否则返回错误代码
**********************************************************************/

LPR_API unsigned int __stdcall LPR_ControlParams(PDEVICEHANDLE pHandle ,ParamsInfo *params,unsigned int nTimeout);

/*******************************************************************
函数实体：unsigned int WINAPI LPR_GetAlgParams(PDEVICEHANDLE pHandle  ,AlgParams *params,unsigned int nTimeout)
函数名称：LPR_GetAlgParams
函数说明：获取算法参数
参数说明:
pHandle相机句柄，由LPR _ConnectCamera获取
params：参数结构体，具体见AlgParams定义
nTimeout:命令执行等待时间
返回值：
返回值是RESULT_OK表示成功，否则返回错误代码
**********************************************************************/

LPR_API unsigned int __stdcall LPR_GetAlgParams(PDEVICEHANDLE pHandle ,AlgParams *params,unsigned int nTimeout);
